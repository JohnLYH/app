odoo.define('zz.echart_map', function (require) {
    'use strict';
...
//coordinateSystem:选择bmap
                ...
                var myChart = echarts.init(document.getElementById('ediv1'));
    ...
    var EchartMap = Widget.extend({template: 'echartMap'});
    core.action_registry.add("echart_map", EchartMap)
